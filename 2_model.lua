...
branch1:add(nn.Dropout(dropout_p))
...
branch2:add(nn.Dropout(dropout_p))
...
branch3:add(nn.Dropout(dropout_p))
...
branch4:add(nn.Dropout(dropout_p))
...
branch1 = nn.Sequential()
branch5:add(nn.Dropout(dropout_p))
...
branch6:add(nn.Dropout(dropout_p))
...
branch7:add(nn.Dropout(dropout_p))
...
branch8:add(nn.Dropout(dropout_p))
...
branch9:add(nn.Dropout(dropout_p))
...
branch10:add(nn.Dropout(dropout_p))
...
branch11:add(nn.Dropout(dropout_p))
